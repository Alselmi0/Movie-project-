                ...
                <>
                    {recommendations.length > 0 ?
                        <div className="recommendations-container">
                            <h3>{language === "en-US" ? "Recommendations" : "توصيات"}</h3>
                            <div className="row">
                                    ...
                                    <div key={index} className="col-6 mb-3 position-relative">
                                        <Link to={`/movie/${recommendation.id}-${recommendation.title?.replaceAll(" ", "-").toLowerCase()}`} onClick={handleClick}>
                                            <LazyLoadImage
                                                ...
                                                alt={`${recommendation.title} صورة الخلفية`}
                        ...
                        <div className="recommendations-container">
                            ...
                            <div className="text-secondary">
                                <p>{language === "en-US" ? "There are no recommendations for this movie." : "لا توجد توصيات لهذا الفيلم."}</p>
                            </div>
                        </div>
                    }
                </>
